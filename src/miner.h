...
public:
    ...
    std::unique_ptr<CBlockTemplate> CreateNewForkBlock(const CScript& scriptPubKeyIn, bool&);
    std::unique_ptr<CBlockTemplate> CreateNewForkBlock(const CScript& scriptPubKeyIn, bool&,const int);
private:
    // utility functions
    ...
    /** mfcoin: add transactions at random */
    void addTxs();
