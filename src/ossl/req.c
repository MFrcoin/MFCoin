/*
/home/neurocod/g/openssl/apps/req.c
	...
	char* outfile)
{
	...
	EVP_PKEY *pkey=NULL;
	int i=0,badops=0,verbose=0,pkey_type=-1;
	long newkey = -1;
	BIO *in=NULL,*out=NULL;
	int informat,outformat,verify=0,noout=0,text=0,keyform=FORMAT_PEM;
	int kludge=0,newhdr=0,subject=0,pubkey=0;
	char *infile,*prog,*keyfile=NULL;
