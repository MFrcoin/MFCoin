...
void CoinControlDialog::updateLabels(WalletModel *model, QDialog* dialog)
{
    ...
    BOOST_FOREACH(const COutput& out, vOutputs) {
        ...
        if (out.tx->tx->vout[out.i].scriptPubKey.IsWitnessProgram(witnessversion, witnessprogram, 0))  // mfcoin: there should not be any names in coin control dialog
        {
    ...
    if (nQuantity > 0)
    {
        ...
        fAllowFree = false; // mfcoin: we have no free transaction
