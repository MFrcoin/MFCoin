...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s mfcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mfcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mfcoin transaction") + "\n" +
              "  mfcoin-tx [options] -create [commands]   " + _("Create hex-encoded mfcoin transaction") + "\n" +
              "\n";
