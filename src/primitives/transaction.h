...
public:
    ...
    CAmount GetDustThreshold(const CFeeRate &minRelayTxFee) const
    {
        ...
        if (scriptPubKey.IsWitnessProgram(witnessversion, witnessprogram, 0)) { // mfcoin: can be ignored for names
...
inline void UnserializeTransaction(TxType& tx, Stream& s) {
    ...
    // mfcoin: do not read/write nTime in case of auxPow tx
...
public:
    ...
    // mfcoin: get bitcoin compatible hash for merged mining usage
