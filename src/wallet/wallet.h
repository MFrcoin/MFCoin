...
static const CAmount WALLET_INCREMENTAL_RELAY_FEE = 5 * (MIN_TX_FEE / 10); // mfcoin: this value was changed by analogy. Most other fees were 1000, this one was 5000.
...
public:
    ...
    bool CreateCoinStake(const CKeyStore& keystore, unsigned int nBits, int64_t nSearchInterval, CMutableTransaction &txNew, bool fV7Enabled, int nHeight);
