...
static bool SolverInner(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    if (scriptPubKey.IsPayToScriptHash(0))  // mfcoin: there is no need to check for names here, because caller of this function will do just that
    {
    ...
    if (scriptPubKey.IsWitnessProgram(witnessversion, witnessprogram, 0)) {  // mfcoin: there is no need to check for names here, because caller of this function will do just that
...
bool Solver(const CScript& scriptPubKey, txnouttype& typeRet, vector<vector<unsigned char> >& vSolutionsRet)
{
    ...
    // mfcoin: remove name (if any exist) and try again
...
// mfcoin: scriptPubKey should come from vout[0]
