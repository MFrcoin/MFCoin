...
BOOST_AUTO_TEST_CASE(floats_conversion)
{
    ...
    BOOST_CHECK_EQUAL(ser_uint32_to_float(0x44444444), 785.0228270390625F);
    ...
    BOOST_CHECK_EQUAL(ser_float_to_uint32(785.0228270390625F), 0x44444444);
}
...
BOOST_AUTO_TEST_CASE(doubles_conversion)
{
    ...
    BOOST_CHECK_EQUAL(ser_uint64_to_double(0x4088888880000000ULL), 785.0228270390625);
    ...
    BOOST_CHECK_EQUAL(ser_double_to_uint64(785.0228270390625), 0x4088888880000000ULL);
}
/*
