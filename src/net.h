...
static const unsigned int MAX_CONSECUTIVE_POS_HEADERS = 2000;
...
public:
    ...
    // mfcoin: temperature to measure how many tx has been sent by this client.
    uint32_t temperature;
    // mfcoin: used to detect branch switches
