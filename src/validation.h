...
static const CAmount HIGH_TX_FEE_PER_KB = 0.0001 * COIN;
...
static const CAmount POW_REWARD = 25 * COIN;
static const CAmount POW_MIN_REWARD = 1 * COIN;
static const CAmount POW_HALVING_PERIOD = 400000; // blocks
 ...
 */
bool ProcessNewBlockHeaders(int32_t& nPoSTemperature, const uint256& lastAcceptedHeader, const std::vector<CBlockHeader>& block, CValidationState& state, const CChainParams& chainparams, const CBlockIndex** ppindex=NULL);
...
bool AcceptToMemoryPool(CTxMemPool& pool, CValidationState &state, const CTransactionRef &tx,
                        ...
                        bool fOverrideMempoolLimit=false, const CAmount nAbsurdFee=0, bool fRandPayCheck=false);
...
// mfcoin: check that tx output is not below MIN_TX_AMOUNT
